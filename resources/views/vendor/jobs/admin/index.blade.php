...
@section('title', trans('jobs::global.name'))

@section('main')

<div ng-app="typicms" ng-cloak ng-controller="ListController" ng-show="!initializing">

    @include('core::admin._button-create', ['module' => 'jobs'])

    <h1>
        <span>@{{ totalModels }} @choice('jobs::global.jobs', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="jobsTable" st-table="displayedModels" st-order st-pipe="callServer" st-filter class="table table-condensed table-main">
            <thead>
                <tr>
            ...
            <tbody ng-class="{'table-loading':isLoading}">
                <tr ng-repeat="model in displayedModels">
                    ...
                    <td>
                        @include('core::admin._button-edit', ['module' => 'jobs'])
                    </td>
